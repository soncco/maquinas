...
$.extend($.validator, {
	...
	messages: {
		...
		url: "Por favor ingrese una URL correcta.",
		date: "Por favor ingrese una fecha correcta.",
		dateISO: "Por favor ingrese una fecha correcta (ISO).",
		dateDE: "Bitte geben Sie ein gültiges Datum ein.",
		number: "Por favor ingrese un número correcto.",
		...
		maxlength: $.format("Por favor no ingrese mas de {0} caracteres."),
		minlength: $.format("Por favor no ingrese menos de {0} caracteres."),
